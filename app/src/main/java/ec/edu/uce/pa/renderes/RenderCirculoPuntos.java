...
import ec.edu.uce.pa.geometrias.CirculoPuntos;


public class RenderCirculoPuntos implements GLSurfaceView.Renderer {
    private CirculoPuntos circuloPuntos;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig eglConfig) {
        ...
        circuloPuntos =new CirculoPuntos(numeroPuntos,ColorPuntos);
    }
