...
public class StarsSistemaTexturas {

    private FloatBuffer bufferVertices;

    private final static int comPorVertices = 3;
    private float[] vertices;
    public StarsSistemaTexturas(int numeroEstrellas, int dist) {
        ...
        bufferVertices = FuncionesSistemaTexturas.generarBuffer(vertices);
